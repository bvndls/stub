...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      'background-gradient-overlay0': 'var(--arc-background-gradient-overlay-color0)',
      'background-gradient-overlay1': 'var(--arc-background-gradient-overlay-color1)',
      'background-gradient-overlay2': 'var(--arc-background-gradient-overlay-color2)',
    },
    extend: {
      fontFamily: {
